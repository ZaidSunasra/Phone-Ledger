  ...
  return (
    <nav className="sticky top-0 z-50 w-full border-b border-gray-200 bg-white/80 backdrop-blur-sm">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-blue-600 p-2 font-bold text-white">
            PL
          </div>
          PhoneLedger
        </a>
        ...
        <div className="hidden items-center gap-4 md:flex">
          <Button
            ...
            variant="outline"
            className="border-gray-300 p-4 text-gray-700 hover:bg-gray-50"
          >
            Login
          </Button>
          <Button
