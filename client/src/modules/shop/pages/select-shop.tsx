                    ...
                    {shops?.shops.map((shop) => {
                        ...
                        return (
                            <Button
                                ...
                                className={`group relative flex h-auto min-h-20 w-full items-center justify-start gap-4 rounded-xl border bg-background px-4 py-4 text-left shadow-sm transition-all duration-200 hover:bg-background hover:shadow-md focus-visible:ring-2 focus-visible:ring-primary ${isSelected
                                    ? "border-primary bg-primary/5 ring-1 ring-primary/20 hover:bg-primary/5"
                                    : "hover:-translate-y-0.5 hover:border-primary/40"
                                    } `}
                            >
                                <div
                                    className={`flex size-11 shrink-0 items-center justify-center rounded-lg transition-colors duration-200 ${isSelected
